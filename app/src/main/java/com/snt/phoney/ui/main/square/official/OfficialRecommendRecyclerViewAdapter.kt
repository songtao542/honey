...
/**
 */
class OfficialRecommendRecyclerViewAdapter(val fragment: OfficialRecommendFragment, val viewModel: SquareViewModel, val disposeBag: CompositeDisposable) : RecyclerView.Adapter<OfficialRecommendRecyclerViewAdapter.ViewHolder>() {
