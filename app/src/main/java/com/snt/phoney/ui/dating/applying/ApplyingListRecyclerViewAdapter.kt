...
import kotlinx.android.synthetic.main.fragment_dating_applying.view.*

/**
 */
class ApplyingListRecyclerViewAdapter() : RecyclerView.Adapter<ApplyingListRecyclerViewAdapter.ViewHolder>() {
        ...
        fun setData(applicant: Applicant) {
            ...
            if (applicant.state == 0) {
                ...
                agreeButton.setOnClickListener {
                    //viewModel.reviewDating(applicant.safeUuid, 1)
                }
                rejectButton.setOnClickListener {
                    //viewModel.reviewDating(applicant.safeUuid, 2)
                }
            } else {
