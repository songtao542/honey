...
/**
 */
class PopularRecommendRecyclerViewAdapter(val fragment: Fragment, val viewModel: SquareViewModel) : RecyclerView.Adapter<PopularRecommendRecyclerViewAdapter.ViewHolder>() {
