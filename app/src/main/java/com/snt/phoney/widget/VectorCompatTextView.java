...
public class VectorCompatTextView extends AppCompatTextView {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            if (mDrawableHeight < 0) mDrawableHeight = 0;
            if (isDrawableAdjustTextWidth) isDrawableAdjustViewWidth = false;
            if (isDrawableAdjustTextHeight) isDrawableAdjustViewHeight = false;
    ...
    private void initDrawables(final Drawable... drawables) {
        ...
        if (!isDrawableAdjustTextWidth && !isDrawableAdjustTextHeight
                ...
                && mDrawableWidth == 0 && mDrawableHeight == 0) {
            ...
            if (isDrawableAdjustTextWidth || isDrawableAdjustTextHeight || isDrawableAdjustViewWidth || isDrawableAdjustViewHeight) {
                boolean invalid = ((isDrawableAdjustTextWidth || isDrawableAdjustViewWidth) && (drawables[0] != null || drawables[2] != null))
                        || ((isDrawableAdjustTextHeight || isDrawableAdjustViewHeight) && (drawables[1] != null || drawables[3] != null));
                if (invalid) {
