...
public class PopupList {
	 ...
	 * 
	 * @param drawable
	 *            设置颜色可使用如下方法：setDivider(new ColorDrawable(color))
	 */
	 ...
	 * 
	 * @param gravity
	 *            Gravity.CENTER,Gravity.CENTER_HORIZONTAL,Gravity.LEFT,Gravity.RIGHT
	 */
	 ...
	 * 
	 * @param dip
	 *            单位是否采用 TypedValue.COMPLEX_UNIT_DIP
	 * @param height
	 *            高度
	 */
	 ...
	 * 
	 * @param anchor
	 *            the view on which to pin the DripDownListView
	 * 
	 * @param gravity
	 *            {@link Gravity} just Gravity.LEFT,Gravity.RIGHT has effect ,other will be as Gravity.CENTER;
	 * @param yoff
	 *            dip
	 * 
	 */
