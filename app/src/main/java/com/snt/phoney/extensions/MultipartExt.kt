...
//inline fun MultipartBody.Part.create(name: String, value: String): MultipartBody.Part {
//    val requestBody = StringRequestBody(name, value)
//    return MultipartBody.Part.createFormData(name, null, requestBody)
//}
//
//inline fun MultipartBody.Part.create(name: String, file: File): MultipartBody.Part {
...
//        else -> {
//            val mime = MultipartUtil.getFileMime(file)
...
//}
//
//inline fun MultipartBody.Part.createList(name: String, files: List<File>): List<MultipartBody.Part> {
...
//}
//
//inline fun MultipartBody.Part.getFileMime(file: File): String {
