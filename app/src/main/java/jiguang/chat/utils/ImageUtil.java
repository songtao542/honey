...
public class ImageUtil {
    ...
    public static String makeThumbnail(Context context, File imageFile) {
        ...
        boolean result = scaleThumbnail(
                imageFile,
                thumbFile,
                getImageMaxEdge(screenWidth),
                getImageMinEdge(screenWidth),
                CompressFormat.JPEG,
                60);
        if (!result) {
    ...
    public static int getImageMaxEdge(int screenWidth) {
        return (int) (165.0 / 320.0 * screenWidth);
    }

    public static int getImageMinEdge(int screenWidth) {
    ...
    public static File getScaledImageFileWithMD5(Context context, File imageFile, String mimeType) {
        ...
        String tempFilePath = getTempFilePath(context, FileUtils.getExtensionName(filePath));
