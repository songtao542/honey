...
public class ExpandableHorizontalScrollView extends HorizontalScrollView {
    ...
    public ExpandableHorizontalScrollView(Context context) {
        super(context);
        init(context, null);
    }
    ...
    public ExpandableHorizontalScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public interface Listener {
        void onExpansionChanged(ExpandableHorizontalScrollView expansionLayout, boolean expanded);
    }

    public interface IndicatorListener {
        void onStartedExpand(ExpandableHorizontalScrollView expansionLayout, boolean willExpand);
    }
}
