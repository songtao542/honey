...
public class ExpandableNestedScrollView extends NestedScrollView {
    ...
    public ExpandableNestedScrollView(Context context) {
        super(context);
        init(context, null);
    }

    public ExpandableNestedScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ExpandableNestedScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        if (attrs != null) {
            final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ExpandableNestedScrollView);
            if (a != null) {
                expanded = a.getBoolean(R.styleable.ExpandableNestedScrollView_expansion_expanded, expanded);
                a.recycle();
            }
        }
    }
    ...
    public interface Listener {
        void onExpansionChanged(ExpandableNestedScrollView expansionLayout, boolean expanded);
    }

    public interface IndicatorListener {
        void onStartedExpand(ExpandableNestedScrollView expansionLayout, boolean willExpand);
    }
}
