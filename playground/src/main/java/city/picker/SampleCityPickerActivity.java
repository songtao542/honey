...
public class SampleCityPickerActivity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener {
                ...
                new CityPickerFragment.Builder()
                        ...
                        .resultListener(new OnResultListener() {
                            ...
                            public void onResult(List<City> data) {
                                ...
                                if (data != null) {
                                    for (City c : data) {
                                        Log.d("TTTT", "select city" + c);
                                    }
                                }
                                currentTV.setText(city == null ? "杭州" : String.format("当前城市：%s，%s", city.getName(), city.getCode()));
                                if (city != null) {
                                    Toast.makeText(
                                            getApplicationContext(),
                                            String.format("点击的数据：%s，%s", city.getName(), city.getCode()),
                                            Toast.LENGTH_SHORT)
                                            .show();
                                }
                            }
